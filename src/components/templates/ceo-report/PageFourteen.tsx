        ...
        <VStack align="flex-start" w="100%" spacing={4}>
          ...
          <TableContainer w="100%">
            ...
            >
              <Thead>
                <Tr>
                  {reportToEdit?.subTitleFourteen[0].table1[0].tableHeader.map(
                ...
                <Tr>
                  {reportToEdit?.subTitleFourteen[0].table1[0].tableHeader2.map(
                    (item: any, index: number) => (
                      <Th
                        key={index}
                        py={3}
              ...
              <Tbody>
                {reportToEdit?.subTitleFourteen[0].table1[1].data.map(
                  (item: any, index: number) => (
                    <Tr key={index}>
...
export default memo(PageFourteen);
